...
private struct WordInsertionWithAnswerOptionsView: View {
...
extension WordInsertionWithAnswerOptions {
    var body: some View {
        WordInsertionWithAnswerOptionsView(
...
struct WordInsertionsWithAnswersView_Previews:
    PreviewProvider
{
    static var previews: some View {
        WordInsertionWithAnswerOptions(
            ...
            correctWord: "is",
            answersOptions: ["are", "is", "him", "what"])
    }
}
