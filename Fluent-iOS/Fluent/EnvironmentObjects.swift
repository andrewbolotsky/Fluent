...
class GlobalStates: ObservableObject {
    ...
    init(
        ...
        courses: [Course], theme: Themes = .Standard,
        currentCourseIndex: Int = 0,
        wordCardsCourses: [Course] = Array(),
        wordInsertionCourses: [Course] = Array(),
        speakingCourses: [Course] = Array(),
        readingCourses: [Course] = Array(),
        crosswordCourses: [Course] = Array(),
        listeningCourses: [Course] = Array()
    ) {
