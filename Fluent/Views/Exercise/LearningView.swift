        ...
        if !next{
            ScrollView {
                VStack{
                    ...
                    .padding()
                    Button("Submit", action: {next = true})
                        .padding()
                }
            }
        }
...
extension Learning: View {
    ...
    var body: some View {
            LearningView(text:markdownText,exerciseIndex: $exerciseIndex)
    }
}
struct LearningView_Previews: PreviewProvider {
    static var previews: some View {
        Learning(id: UUID().hashValue, complexity: 12, languageFrom: .Russian, languageTo: .English, markdownText: """
# Heading 1
## Heading 2
### Heading 3
#### Heading 4
